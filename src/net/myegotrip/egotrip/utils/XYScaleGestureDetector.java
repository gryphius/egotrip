...
public class XYScaleGestureDetector {
	...
	public float getCurrentSpanX() {
		return Math.max(5.0f, Math.abs(mCurrFingerDiffX));
	}

	public float getCurrentSpanY() {
		return Math.max(5.0f,  Math.abs(mCurrFingerDiffY));
	}

	public float getPreviousSpanX() {
		return Math.max(5.0f, Math.abs(mPrevFingerDiffX));
	}

	public float getPreviousSpanY() {
		return Math.max(5.0f, Math.abs(mPrevFingerDiffY));
	}
	...
	public float getScaleFactorX() {
		if (mScaleFactorX == -1) {
			// if dx is small, scaling is close to 1
